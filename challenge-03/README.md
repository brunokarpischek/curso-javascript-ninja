...
*/
var pessoa = {nome:"Bruno", sobrenome: "Karpischek", sexo:"Masculinoo", idade: 26, altura: 1.83, peso: 135, andando: false, caminhouQuantosMetros: 0};
...
for chamado.
*/
pessoa.fazerAniverssario = function(){pessoa.idade++;};
...
*/
pessoa.nomeCompleto(); //"Olá! Meu nome é Bruno Karpischek !"
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); //"Eu peso 135Kg."

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura() //"Minha Altura e 1.83m."
